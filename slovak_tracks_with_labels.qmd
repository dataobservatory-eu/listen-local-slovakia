...
-   **spotify_artist_id:** A 22 character string that identifies the artist Spotify. This is know as artist ID on Spotify.

-   **spotify_artist_uri:** A 37 character string that represents the Spotify URI of the artist.

-   **isrc:** A 12 character string representing the International Standard Recording Code of the track (@ISO39101, @isrchandbook). It is unique for every track.
